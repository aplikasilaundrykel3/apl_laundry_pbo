 ...
 * @author RPL
 */
public class form_paket extends javax.swing.JFrame {
    Connection con;
    ...
    private void tampil_tabel(){
        ...
        new Object[]{"id_paket","id_outlet","jenis","nama_paket","harga"});
        tblpaket.setModel(tm);
        tm.getDataVector().removeAllElements();
        try{
            PreparedStatement s=con.prepareStatement("SELECT * FROM paket");
    ...
    public void cbidoutlet(){
        try {
            ...
            ResultSet r=s.executeQuery();
            while (r.next()){
                cbid.addItem(r.getString("id_outlet"));
            }
    ...
    private void initComponents() {
        ...
        cbjenis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "kiloan", "selimut", "bed_cover", "kaos" }));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(102, 102, 102))
                                .addComponent(txtnama, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if (ok==0){
            try {
                PreparedStatement ps = con.prepareStatement("DELETE FROM paket WHERE id_paket=?");
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        // TODO add your handling code here:
        try{
            PreparedStatement ps = con.prepareStatement("UPDATE paket SET id_outlet=?, jenis=?, nama_paket=?, harga=? WHERE id_paket=?");
            ps.setString(1, cbid.getSelectedItem().toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        tm.getDataVector().removeAllElements();
        try{
            PreparedStatement s=con.prepareStatement("SELECT * FROM paket WHERE "
            + "nama_paket LIKE '%"+ txtcari.getText().toString()+"%'");
            ResultSet r = s.executeQuery();
            while (r.next()){
                Object[] data={
                    r.getString(1),
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        try{
            ...
            ps.setString(5, txtharga.getText());
            ps.executeUpdate();
    ...
    private void tblpaketMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblpaketMouseClicked
        ...
        txtid.setText(id);
        String id_outlet = (String) tm.getValueAt(i, 1);
        cbid.setSelectedItem(id_outlet);
        String jenis = (String) tm.getValueAt(i, 2);
        cbjenis.setSelectedItem(jenis);
        String nama_paket = (String) tm.getValueAt(i, 3);
        txtnama.setText(nama_paket);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_paket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_paket().setVisible(true);
            }
        });
    }
